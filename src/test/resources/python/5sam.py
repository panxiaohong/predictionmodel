...
with open(file_package+'sdcoffee_log_t.txt', 'r') as rf:
    for line in rf:
        count = count + 1
...
wf_b1 = open(file_package+'train1.txt', 'a')
wf_b2 = open(file_package+'train2.txt', 'a')
wf_b3 = open(file_package+'train3.txt', 'a')
wf_b4 = open(file_package+'train4.txt', 'a')
wf_b5 = open(file_package+'train5.txt', 'a')
